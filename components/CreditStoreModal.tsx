...
interface CreditStoreModalProps {
  currentUser: User;
  onCreditsPurchased: (bundle: CreditBundle) => void;
  onClose: () => void;
}

const CreditStoreModal: React.FC<CreditStoreModalProps> = ({ currentUser, onCreditsPurchased, onClose }) => {
        ...
        try {
          const buttons = window.paypal.Buttons({
            ...
            onApprove: async (data: any, actions: any) => {
              ...
              onCreditsPurchased(selectedBundle);
              setIsPaying(false);
              onClose();
            },
            onError: (err: any) => {
  ...
  }, [step, sdkReady, selectedBundle, mountKey, buttonsRendered, onCreditsPurchased, onClose]);
